...
//@brief Mock implementation of TerminalManager designed for headless unit testing.
//Records pixel operations in-memory without initializing an interactive terminal session.
class MockTerminalManager : public TerminalManager {
public:
    MockTerminalManager(int rows, int cols)
        : rowCount_(rows), colCount_(cols) {}
